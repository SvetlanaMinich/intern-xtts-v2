...
class BaseTacotron(BaseTTS):
    ...
    def on_epoch_start(self, trainer):
        ...
        if self.gradual_training:
            r, TTS.Trainer.trainer.config.batch_size = gradual_training_scheduler(TTS.Trainer.trainer.total_steps_done, TTS.Trainer.trainer.config)
            TTS.Trainer.trainer.config.r = r
            self.decoder.set_r(r)
            if TTS.Trainer.trainer.config.bidirectional_decoder:
                TTS.Trainer.trainer.model.decoder_backward.set_r(r)
