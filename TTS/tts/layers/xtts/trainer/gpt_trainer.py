...
from TTS.Trainer.trainer.torch import DistributedSampler
from TTS.Trainer.trainer.trainer_utils import get_optimizer, get_scheduler
...
from TTS.tts.layers.xtts.TTS.Trainer.trainer.dataset import XTTSDataset
...
class GPTTrainer(BaseTTS):
    ...
    def on_train_epoch_start(self, trainer):
        TTS.Trainer.trainer.model.eval()  # the whole model to eval
        # put gpt model in training mode
        if hasattr(TTS.Trainer.trainer.model, "module") and hasattr(TTS.Trainer.trainer.model.module, "xtts"):
            TTS.Trainer.trainer.model.module.xtts.gpt.train()
        else:
            TTS.Trainer.trainer.model.xtts.gpt.train()
