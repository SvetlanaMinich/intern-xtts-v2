...
from TTS.Trainer.trainer.logging.console_logger import ConsoleLogger
from TTS.Trainer.trainer.logging.dummy_logger import DummyLogger
...
def logger_factory(config, output_path):
    ...
    if config.dashboard_logger == "tensorboard":
        ...
        from TTS.Trainer.trainer.logging.wandb_logger import WandbLogger
