...
class JsonStorage:
    ...
    async def add_client(self, client_id:int, voice:bytes) -> None:
    ...
    async def update_client(self, client_id:int, voice:bytes) -> None:
    ...
    async def get_voice_by_client_id(self, client_id:int) -> bytes:
        clients = os.listdir(path=self.json_dir)
