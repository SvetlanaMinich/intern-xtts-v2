...
class Synthesizer(nn.Module):
    ...
    def _load_tts(self, tts_checkpoint: str, tts_config_path: str, use_cuda: bool = True) -> None:
        """Load the TTS model.
    ...
    def _load_vocoder(self, model_file: str, model_config: str, use_cuda: bool = True) -> None:
