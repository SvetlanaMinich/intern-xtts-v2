...
from TTS.Trainer.trainer.trainer_utils import is_apex_available
...
class TrainerModel(ABC, nn.Module):
    ...
    def scaled_backward(
        ...
        """
        if TTS.Trainer.trainer.use_amp_scaler:
            if TTS.Trainer.trainer.use_apex:
                ...
                TTS.Trainer.trainer.scaler.scale(loss).backward()
        else:
