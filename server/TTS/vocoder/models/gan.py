...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit, ap: AudioProcessor = None):
        """Wrap a generator and a discriminator network. It provides a compatible interface for the TTS.Trainer.trainer.
    ...
    def on_train_step_start(self, trainer) -> None:
        ...
        """
        self.train_disc = TTS.Trainer.trainer.total_steps_done >= self.config.steps_to_start_discriminator
