...
from TTS.Trainer.trainer.torch import DistributedSampler, DistributedSamplerWrapper
...
class DelightfulTTS(BaseTTSE2E):
    ...
    def on_train_step_start(self, trainer) -> None:
        ...
        """
        self.binary_loss_weight = min(TTS.Trainer.trainer.epochs_done / self.config.binary_loss_warmup_epochs, 1.0) * 1.0
        self.train_disc = (  # pylint: disable=attribute-defined-outside-init
            TTS.Trainer.trainer.total_steps_done >= self.config.steps_to_start_discriminator
        )
