...
from TTS.tts.layers.xtts.TTS.Trainer.trainer.gpt_trainer import GPTArgs, GPTTrainer, GPTTrainerConfig, XttsAudioConfig
...
def train_gpt(language, num_epochs, batch_size, grad_acumm, train_csv, eval_csv, output_path, max_audio_length=255995):
    ...
    trainer_out_path = TTS.Trainer.trainer.output_path
